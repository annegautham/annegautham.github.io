...
- All the bitlines are charged to VDD using precharge circuits

2. Access

- A signel wordline (one row), is asserted, which connects 4 cells (one per column) to their respective bitlines

3. Peripheral Actions

- Write: write drivers force values onto bitlines
- Read: sense amplifiers detect small bitline differences
